...
CREATE TABLE BENUTZER(
	...
	REFERENCES ADRESSEN (AID) ON UPDATE CASCADE);
...
CREATE TABLE SONGS (
	...
	REFERENCES GENRES (GID) ON UPDATE CASCADE
...
CREATE TABLE SONG_ALBUM (
	...
	REFERENCES ALBUM (AID) ON UPDATE CASCADE
...
CREATE TABLE KAUF_SONGBESITZ (
	...
	,CONSTRAINT UC_SONGBESITZ UNIQUE (BID, SID)
...
CREATE TABLE BENUTZERBEWERTUNG (
	...
	REFERENCES KAUF_SONGBESITZ (KID) ON DELETE CASCADE);
...
CREATE TABLE PLAYLISTS (
	...
	,CONSTRAINT UC_PLAYLISTS UNIQUE (Playlistname, BID)
...
CREATE TABLE BENUTZER_PLAYLIST (
	...
	REFERENCES KAUF_SONGBESITZ (KID) ON UPDATE CASCADE
	,CONSTRAINT BP_PLAYLISTS_FK FOREIGN KEY (PID) 
	REFERENCES PLAYLISTS (PID) ON DELETE CASCADE);
