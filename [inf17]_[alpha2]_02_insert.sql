...
(KID, SID, Bewertung)
VALUES
((SELECT KID FROM KAUF_SONGBESITZ WHERE BID = (SELECT BID FROM BENUTZER WHERE Benutzername = '')),(SELECT SID FROM SONGS WHERE Songtitel = ''),'')
,((SELECT KID FROM KAUF_SONGBESITZ WHERE BID = (SELECT BID FROM BENUTZER WHERE Benutzername = '')),(SELECT SID FROM SONGS WHERE Songtitel = ''),'')
,((SELECT KID FROM KAUF_SONGBESITZ WHERE BID = (SELECT BID FROM BENUTZER WHERE Benutzername = '')),(SELECT SID FROM SONGS WHERE Songtitel = ''),'')
,((SELECT KID FROM KAUF_SONGBESITZ WHERE BID = (SELECT BID FROM BENUTZER WHERE Benutzername = '')),(SELECT SID FROM SONGS WHERE Songtitel = ''),'')
,((SELECT KID FROM KAUF_SONGBESITZ WHERE BID = (SELECT BID FROM BENUTZER WHERE Benutzername = '')),(SELECT SID FROM SONGS WHERE Songtitel = ''),'');
...
VALUES
('',(SELECT BID FROM BENUTZER WHERE Benutzername = ''),(SELECT KID FROM KAUF_SONGBESITZ WHERE SID = (SELECT SID FROM SONGS WHERE Songtitel = '')))
,('',(SELECT BID FROM BENUTZER WHERE Benutzername = ''),(SELECT KID FROM KAUF_SONGBESITZ WHERE SID = (SELECT SID FROM SONGS WHERE Songtitel = '')))
,('',(SELECT BID FROM BENUTZER WHERE Benutzername = ''),(SELECT KID FROM KAUF_SONGBESITZ WHERE SID = (SELECT SID FROM SONGS WHERE Songtitel = '')))
,('',(SELECT BID FROM BENUTZER WHERE Benutzername = ''),(SELECT KID FROM KAUF_SONGBESITZ WHERE SID = (SELECT SID FROM SONGS WHERE Songtitel = '')))
,('',(SELECT BID FROM BENUTZER WHERE Benutzername = ''),(SELECT KID FROM KAUF_SONGBESITZ WHERE SID = (SELECT SID FROM SONGS WHERE Songtitel = '')));
